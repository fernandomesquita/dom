...
CREATE TABLE `avisos_analytics` (
  ...
  CONSTRAINT `fk_1` FOREIGN KEY (`aviso_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`avisos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `material_ratings` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1` FOREIGN KEY (`material_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`materiais` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_2` FOREIGN KEY (`user_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `metas_materiais` (
  ...
  CONSTRAINT `fk_1` FOREIGN KEY (`meta_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`metas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_2` FOREIGN KEY (`material_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`materiais` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `metas_questoes` (
  ...
  KEY `fk_2` (`questao_id`),
  CONSTRAINT `fk_1` FOREIGN KEY (`meta_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`metas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_2` FOREIGN KEY (`questao_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`questoes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `planos_estudo` (
  ...
  CONSTRAINT `fk_1` FOREIGN KEY (`usuario_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_2` FOREIGN KEY (`criado_por_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
