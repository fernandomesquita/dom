...
CREATE TABLE `material_ratings` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1005` FOREIGN KEY (`material_id`) REFERENCES `materiais` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1006` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `material_votes` (
  ...
  KEY `idx_user_id` (`user_id`),
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1007` FOREIGN KEY (`material_id`) REFERENCES `materiais` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1008` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `metas_materiais` (
  ...
  CONSTRAINT `fk_1009` FOREIGN KEY (`meta_id`) REFERENCES `metas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1010` FOREIGN KEY (`material_id`) REFERENCES `materiais` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `metas_questoes` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  KEY `fk_2` (`questao_id`),
  CONSTRAINT `fk_1011` FOREIGN KEY (`meta_id`) REFERENCES `metas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1012` FOREIGN KEY (`questao_id`) REFERENCES `questoes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `planos_estudo` (
  ...
  CONSTRAINT `fk_1013` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1014` FOREIGN KEY (`criado_por_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
