...
CREATE TABLE `avisos_analytics` (
  ...
  CONSTRAINT `fk_1000` FOREIGN KEY (`aviso_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`avisos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `avisos_fila_entrega` (
  ...
  CONSTRAINT `fk_1001` FOREIGN KEY (`aviso_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`avisos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `avisos_segmentacao` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1002` FOREIGN KEY (`aviso_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`avisos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `avisos_templates` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1003` FOREIGN KEY (`tipo`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`avisos_tipos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `avisos_visualizacoes` (
  ...
  CONSTRAINT `fk_1004` FOREIGN KEY (`aviso_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`avisos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `material_ratings` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1005` FOREIGN KEY (`material_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`materiais` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1006` FOREIGN KEY (`user_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `material_votes` (
  ...
  KEY `idx_user_id` (`user_id`),
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  CONSTRAINT `fk_1007` FOREIGN KEY (`material_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`materiais` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1008` FOREIGN KEY (`user_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `metas_materiais` (
  ...
  CONSTRAINT `fk_1009` FOREIGN KEY (`meta_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`metas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1010` FOREIGN KEY (`material_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`materiais` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `metas_questoes` (
  ...
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
  KEY `fk_2` (`questao_id`),
  CONSTRAINT `fk_1011` FOREIGN KEY (`meta_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`metas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1012` FOREIGN KEY (`questao_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`questoes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `planos_estudo` (
  ...
  CONSTRAINT `fk_1013` FOREIGN KEY (`usuario_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_1014` FOREIGN KEY (`criado_por_id`) REFERENCES `E9go4Z3vKfQ64CyBjNz69u`.`users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
