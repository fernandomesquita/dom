  ...
  create: protectedProcedure
    .input(
      z.object({
        ...
        midiaUrl: z.string().url().nullish(),
        midiaThumbnail: z.string().url().nullish(),
        ctaTexto: z.string().max(50).nullish(),
        ctaUrl: z.string().url().nullish(),
        ctaEstilo: z.enum(["primary", "secondary", "outline"]).nullish(),
        ctaSecundarioTexto: z.string().max(50).nullish(),
        ctaSecundarioUrl: z.string().url().nullish(),
